...
<div class="card shadow-sm border-0 max-w-lg mx-auto">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('borrows/process_return/' . $borrow['id']) ?>" method="post" class="mt-4">
            ...
            <a href="<?= base_url('borrows') ?>" class="btn btn-outline-secondary mt-3 w-100">Cancel</a>
        </form>
