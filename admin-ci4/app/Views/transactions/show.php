...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4><?= esc($title) ?></h4>
    <a href="<?= base_url('transactions') ?>" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back</a>
</div>
            ...
            <div class="card-body mt-3">
                ...
                <?php if($borrow['status'] !== 'returned'): ?>
                    ...
                    <div class="text-center mt-4">
                        <a href="<?= base_url('transactions/process_return/' . $borrow['id']) ?>" class="btn btn-success btn-lg w-100"><i class="bi bi-arrow-return-left"></i> Process Return Now</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
